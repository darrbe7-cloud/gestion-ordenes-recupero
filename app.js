...
async function doLogout(skipCall) {
  ...
  STATE = { rol: null, username: null, metaLists: { comunas: [], tipos: [] }, dataPage: 0, dataPageSize: 100, dataSearch: '', dataTipoFilter: [], usersCache: [], processing: false };
...
async function loadMetaStats() {
  ...
  try {
    ...
    STATE.metaLists = { comunas: meta.comunas, tipos: meta.tipos };
    el.innerHTML =
